...
const odf_1 = __importDefault(require("./odf"));
class Reversal {
    constructor() { }
    ;
    static async returnPoint(req, res) {
        const apiResponse = req.body || null;
        const { DEVOLUVAO_MOD, SUPERVISOR_MOD, RESERVA_MOD, supervisor, quantity } = apiResponse;
